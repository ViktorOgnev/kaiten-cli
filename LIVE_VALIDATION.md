...
- `live_not_validated`
  Команда добавлена после последней полной campaign. В live suite сценарий для неё есть, но
  реального прогона, подтверждающего контракт, ещё не было.
...
Статус `live_not_validated` покрытием не считается: он честно фиксирует, что сценарий в
harness уже написан, но прогона ещё не было.
