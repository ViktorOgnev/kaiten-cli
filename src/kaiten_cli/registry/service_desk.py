...
from kaiten_cli.runtime.behaviors import archive_service_request, service_desk_stats_query_request
...
TOOLS = (
    make_tool(
        ...
        operation=OperationSpec(
            method="GET",
            path_template="/service-desk/requests",
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="POST",
            path_template="/service-desk/requests",
            body_fields=("title", "service_id", "description", "priority"),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        input_schema={
            "type": "object",
            "properties": {"request_id": {"type": "integer", "description": "Request ID"}},
            "required": ["request_id"],
        },
        operation=OperationSpec(
            method="GET",
            path_template="/service-desk/requests/{request_id}",
            path_fields=("request_id",),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            ...
            path_template="/service-desk/requests/{request_id}",
            path_fields=("request_id",),
            body_fields=("title", "description", "priority"),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="GET",
            path_template="/service-desk/services",
            query_fields=("query", "include_archived", "limit", "offset"),
        ),
        response_policy=ResponsePolicy(default_limit=DEFAULT_LIMIT, result_kind="list"),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        input_schema={
            "type": "object",
            "properties": {"service_id": {"type": "integer", "description": "Service ID"}},
            "required": ["service_id"],
        },
        operation=OperationSpec(
            method="GET",
            path_template="/service-desk/services/{service_id}",
            path_fields=("service_id",),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                ...
                "lng": {"type": "string", "enum": ["en", "ru"], "description": "Language code"},
                "display_status": {
                    "type": "string",
                    "enum": ["by_column", "by_state"],
                    "description": "How status is displayed",
                },
                "column_id": {"type": "integer", "description": "Default column ID"},
                "lane_id": {"type": "integer", "description": "Default lane ID"},
                "type_id": {"type": "integer", "description": "Card type ID"},
                "email_settings": {"type": "integer", "description": "Email settings bitmask"},
                "fields_settings": {
                    "type": "object",
                    "description": "Request form fields configuration",
                },
                "settings": {"type": "object", "description": "Additional settings"},
                "allow_to_add_external_recipients": {
                    "type": "boolean",
                    "description": "Allow external recipients",
                },
                "hide_in_list": {"type": "boolean", "description": "Hide service in list"},
                "is_default": {"type": "boolean", "description": "Set as default service"},
            },
            "required": ["name", "board_id", "position", "lng"],
        },
        operation=OperationSpec(
            method="POST",
            path_template="/service-desk/services",
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                ...
                "lng": {"type": "string", "description": "Language code"},
                "display_status": {
                    "type": "string",
                    "enum": ["by_column", "by_state"],
                    "description": "How status is displayed",
                ...
                "settings": {"type": "object", "description": "Additional settings"},
                "archived": {"type": "boolean", "description": "Archive or unarchive service"},
                "allow_to_add_external_recipients": {
                    "type": "boolean",
                    "description": "Allow external recipients",
                },
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                "query": {"type": "string", "description": "Search filter"},
                "includeUsers": {"type": "boolean", "description": "Include organization users"},
                "limit": {"type": "integer", "description": "Max results"},
                "offset": {"type": "integer", "description": "Pagination offset"},
            },
        },
        operation=OperationSpec(
            method="GET",
            path_template="/service-desk/organizations",
            query_fields=("query", "includeUsers", "limit", "offset"),
        ),
        response_policy=ResponsePolicy(default_limit=DEFAULT_LIMIT, result_kind="list"),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="GET",
            path_template="/service-desk/organizations/{organization_id}",
            path_fields=("organization_id",),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="GET", path_template="/service-desk/sla", query_fields=("limit", "offset")
        ),
        response_policy=ResponsePolicy(default_limit=DEFAULT_LIMIT, result_kind="list"),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        input_schema={
            "type": "object",
            "properties": {"sla_id": {"type": "string", "description": "SLA ID (UUID)"}},
            "required": ["sla_id"],
        },
        operation=OperationSpec(
            method="GET", path_template="/service-desk/sla/{sla_id}", path_fields=("sla_id",)
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                ...
                "rules": {"type": "array", "items": {"type": "object"}, "description": "SLA rules"},
        ...
        operation=OperationSpec(
            method="POST",
            path_template="/service-desk/sla",
            body_fields=("name", "rules", "notification_settings", "v2"),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="PATCH",
            path_template="/service-desk/sla/{sla_id}",
            path_fields=("sla_id",),
            body_fields=("name", "status", "notification_settings", "should_delete_sla_from_cards"),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="DELETE", path_template="/service-desk/sla/{sla_id}", path_fields=("sla_id",)
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="GET",
            path_template="/service-desk/template-answers/{template_answer_id}",
            path_fields=("template_answer_id",),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="POST",
            path_template="/service-desk/template-answers",
            body_fields=("name", "text"),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                "template_answer_id": {
                    "type": "string",
                    "description": "Template answer ID (UUID)",
                },
                "name": {"type": "string", "description": "Template name"},
                "text": {"type": "string", "description": "Template answer text"},
            },
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                ...
                "start_column_uid": {"type": "string", "description": "Start column UID"},
                "finish_column_uid": {"type": "string", "description": "Finish column UID"},
        ...
        operation=OperationSpec(
            method="POST",
            path_template="/service-desk/sla/{sla_id}/rules",
            path_fields=("sla_id",),
            body_fields=(
                "type",
                "calendar_id",
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="PATCH",
            path_template="/service-desk/sla/{sla_id}/rules/{rule_id}",
            path_fields=("sla_id", "rule_id"),
            body_fields=(
                "type",
                "calendar_id",
                "start_column_uid",
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="POST",
            path_template="/service-desk/sla/{sla_id}/recalculate-measurements",
            path_fields=("sla_id",),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                ...
                "limit": {"type": "integer", "description": "Max results"},
                "offset": {"type": "integer", "description": "Pagination offset"},
                "include_paid_users": {"type": "boolean", "description": "Include paid users"},
                "include_all_sd_users": {"type": "boolean", "description": "Include all SD users"},
            },
        },
        operation=OperationSpec(
            method="GET",
            path_template="/service-desk/users",
            query_fields=("query", "limit", "offset", "include_paid_users", "include_all_sd_users"),
        ),
        response_policy=ResponsePolicy(default_limit=DEFAULT_LIMIT, result_kind="list"),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="PATCH",
            path_template="/service-desk/users/{user_id}",
            path_fields=("user_id",),
            body_fields=("full_name", "lng"),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="PATCH",
            path_template="/service-desk/users/set-temporary-password/{user_id}",
            path_fields=("user_id",),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="POST",
            path_template="/service-desk/organizations/{organization_id}/users",
            path_fields=("organization_id",),
            body_fields=("user_id", "permissions"),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="PATCH",
            path_template="/service-desk/organizations/{organization_id}/users/{user_id}",
            path_fields=("organization_id", "user_id"),
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="PATCH",
            path_template="/sd-settings/current",
            body_fields=("service_desk_settings",),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="GET",
            path_template="/service-desk/stats",
            query_fields=("date_from", "date_to", "service_id", "report"),
        ),
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                "date_from": {"type": "string", "description": "Start date (ISO format)"},
                "date_to": {"type": "string", "description": "End date (ISO format)"},
                "sla_id": {"type": "string", "description": "SLA ID"},
                "service_id": {"type": "integer", "description": "Service ID"},
        ...
        operation=OperationSpec(
            method="GET",
            path_template="/service-desk/sla-stats",
            query_fields=(
                "date_from",
                "date_to",
                "sla_id",
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                "service_id": {"type": "integer", "description": "Service ID"},
                "id": {"type": "integer", "description": "Custom property ID"},
            },
            "required": ["service_id", "id"],
        },
        operation=OperationSpec(
            method="POST",
            path_template="/service-desk/services/{service_id}/vote-properties",
            path_fields=("service_id",),
            body_fields=("id",),
        ),
        examples=(
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                "service_id": {"type": "integer", "description": "Service ID"},
                "property_id": {"type": "integer", "description": "Vote property ID"},
            },
            "required": ["service_id", "property_id"],
        },
        operation=OperationSpec(
            method="DELETE",
            path_template="/service-desk/services/{service_id}/vote-properties/{property_id}",
            path_fields=("service_id", "property_id"),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="POST",
            path_template="/cards/{card_id}/slas",
            path_fields=("card_id",),
            body_fields=("sla_id",),
        ),
        examples=(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="DELETE",
            path_template="/cards/{card_id}/slas/{sla_id}",
            path_fields=("card_id", "sla_id"),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="GET",
            path_template="/cards/{card_id}/sla-rules-measurements",
            path_fields=("card_id",),
        ),
        examples=(
            ExampleSpec(
    ...
    make_tool(
        ...
        operation=OperationSpec(
            method="GET",
            path_template="/spaces/{space_id}/sla-rules-measurements",
