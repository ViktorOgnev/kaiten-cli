    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                ...
                "filter": {
                    "type": "object",
                    "description": "Local filter object for card selection.",
                },
                "view": {
                    "type": "string",
                ...
                "fields": {
                    "type": "string",
                    "description": "Comma-separated card or derived field names to keep.",
                },
    ...
    make_tool(
        ...
        input_schema={
            ...
            "properties": {
                ...
                "filter": {
                    "type": "object",
                    "description": "Optional local filter object applied before metrics.",
                },
                "group_by": {
                    "type": ["string", "null"],
                    "enum": [
